...
namespace Clidapos.Wpf.Views
{
    public partial class UnitCategoryPopup : Window
    {
        ...
        /// <summary>
        /// Save only ever creates a brand-new unit. Once something has been
        ...
        private async void Save_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                ErrorText.Text = "Type a unit name first.";
                return;
            }
            ...
            {
                ErrorText.Text = $"A unit named '{name}' already exists.";
                return;
            }

            await _unitService.EnsureExistsAsync(name);
            await _logService.LogAsync(CurrentSession.UserId, $"Added Unit Category '{name}'");
            _editing = null;
            NameInput.Text = "";
        ...
        private async void Update_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                ErrorText.Text = "Use Get Data, pick a unit, then edit and Update.";
                return;
            }
            ...
            {
                ErrorText.Text = $"A unit named '{newName}' already exists.";
                return;
            }

            var confirm = MessageBox.Show(
                $"Rename unit '{_editing}' to '{newName}'?",
            ...
            try
            {
                ...
                await _logService.LogAsync(CurrentSession.UserId, $"Renamed Unit Category '{oldName}' to '{newName}'");
                _editing = newName;
        ...
        private async void Delete_Click(object sender, RoutedEventArgs e)
        {
            if (string.IsNullOrEmpty(_editing))
            {
                ErrorText.Text = "Use Get Data, pick a unit, then Delete.";
                return;
            }
            ...
            await _logService.LogAsync(CurrentSession.UserId, $"Deleted Unit Category '{deletedName}'");
            _editing = null;
            NameInput.Text = "";
            SetMode(isExisting: false);
